...
class AIsupport(loader.Module):
    ...
    async def aisupcmd(self, message):
        ...
        🧠Скормлены знания: 
        • Установки, команды встроенных модулей, чаты Хикки, нюнсы Хикки, прочей мелкой информации
        """
        r = "sup"
    ...
    async def aierrorcmd(self, message):
        ...
        🧠Скормлены знания:
        • команды встроенных модулей, чаты Хикки, больше нюансов Хикки, примеры ошибок и их решений, документация Хикки, большой список советов по устранению ошибок
        """
        r = "error"
