...
class AIsupport(loader.Module):
    ...
    async def aisupcmd(self, message):
        ...
        🧠Скормлены знания: 
        • Установки | команды встроенных модулей | чаты Хикки | нюнсы Хикки | официальные тгк с модулями | меры безопасности | Список советов по устранению ошибок.
        """
        r = "sup"
    ...
    async def aierrorcmd(self, message):
        ...
        🧠Скормлены знания:
        • команды встроенных модулей | чаты Хикки | больше нюансов и принципов работы Хикки | примеры ошибок и их решений | документация по написанию модулей Хикки (урезанная) | большой список советов по устранению ошибок
        """
        r = "error"
